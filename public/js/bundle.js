...
/* eslint-disable */
var displayMap = function displayMap(locate) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF0ZWVoMTAiLCJhIjoiY2w2MHQxcWQ3MDNuNjNibzJvcGo2c21kYSJ9.BiXm74ALYq927b3wlGziug';
  ...
  locate.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extends map bound to include current loction
...
var stripe = Stripe('pk_test_51LR1uILUBfZNGw78keWDKneOwwU6wf9AsB5rlkdy9Wt7bHKFMcTa4CHgCwcRLFl8rXhJzuQGtZ2ixEsoheR2BQch00tRO13d3h');
...
if (mapbox) {
  var locate = JSON.parse(mapbox.dataset.locations);
  (0, _mapBox.displayMap)(locate);
}
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; //Whenever there is - it will automatically convert to camelcase
